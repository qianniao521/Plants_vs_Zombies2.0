...
class Zombie3:
    def __init__(self, r):
        ...
        self.status = 2         #行为状态：0-移动，1-攻击，2-死
        self.r = r
        ...
        self.im2 = load_image("game_picture/zombies/zombie3/2")
        self.im3 = load_image("game_picture/zombies/zombie3/3")
