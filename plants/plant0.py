...
class Plant0:
    def __init__(self, ranks):
        ...
        self.r = ranks[0]
        self.pos = [(self.ranks[1] + 0.5) * lawn_cube_size[0] + pos_lawn[0], (self.ranks[0] + 1) * lawn_cube_size[1] + pos_lawn[1] - 10]#实际位置
        self.im0 = load_image("game_picture/plants/plant0/0")
        self.im1 = load_image("game_picture/plants/plant0/0")
        self.im = [self.im0, self.im1]
        self.image = self.im[self.status][self.actions]
        self.attack_interval = 36  # 攻速,最大攻击间隔
    ...
    def add_bullet(self, bullets):
        bullets.append(Bullet0(self.ranks))
