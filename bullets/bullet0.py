...
class Bullet0:
    def __init__(self, ranks):
        ...
        self.r = ranks[0]
        self.pos = [self.ranks[1] * lawn_cube_size[0] + pos_lawn[0] + 60, (self.ranks[0] + 1) * lawn_cube_size[1] + pos_lawn[1] - 70]    #宽高
        self.attack_range = [self.pos[0] - self.attack_distance, self.pos[0] + self.attack_distance / 2]  # 攻击范围
        self.im0 = pygame.image.load("game_picture/plants/bullet1/0/0.png")
        #gif0 = pygame.transform.scale(gif0, (46, 28))      #pygame.Rect((22, 4, 20, 20)
        self.im1 = pygame.image.load("game_picture/plants/bullet1/1/1.png")
